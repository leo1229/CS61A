...
def add_church(m, n):
    ...
    """
    "*** YOUR CODE HERE ***"
    num1=church_to_int(m)
    num2=church_to_int(n)
    r=m
    while num2>0:
        r,num2=successor(r),num2-1
    return r
